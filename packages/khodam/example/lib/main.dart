...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    _dio.interceptors.add(_khodam.getDioInterceptor());
    _httpClient = HttpClient();
    _chopper = ChopperClient(
      interceptors: _khodam.getChopperInterceptor(),
    );
  ...
  Widget build(BuildContext context) {
    return OverlaySupport(
      child: MaterialApp(
        ...
        navigatorKey: _khodam.getNavigatorKey(),
        debugShowCheckedModeBanner: false,
        home: Scaffold(
          appBar: AppBar(
            title: const Text('Khodam HTTP Inspector - Example'),
          ),
          body: Container(
            ...
            child: ListView(
              children: [
                ...
                _getTextWidget(
                    "Welcome to example of Khodam Http Inspector. Click buttons below to generate sample data."),
                ElevatedButton(
  ...
  void _runHttpHttpRequests() async {
    ...
    http
        .post(Uri.parse('https://jsonplaceholder.typicode.com/posts'),
            body: body)
        .interceptWithKhodam(_khodam, body: body);

    http
        .get(Uri.parse('https://jsonplaceholder.typicode.com/posts'))
        .interceptWithKhodam(_khodam);
    ...
    http
        .post(Uri.parse('https://jsonplaceholder.typicode.com/posts'),
            body: body)
        .then((response) {
      _khodam.onHttpResponse(response, body: body);
    });

    http
        .get(Uri.parse('https://jsonplaceholder.typicode.com/posts'))
        .then((response) {
      _khodam.onHttpResponse(response);
    });
  ...
  void _runHttpHttpClientRequests() {
    ...
    _httpClient
        ...
        .interceptWithKhodam(_khodam, body: body, headers: Map());
    ...
    _httpClient
        .postUrl(Uri.parse("https://jsonplaceholder.typicode.com/posts"))
        .then((request) async {
      _khodam.onHttpClientRequest(request, body: body);
      request.write(body);
      var httpResponse = await request.close();
      var responseBody = await utf8.decoder.bind(httpResponse).join();
      _khodam.onHttpClientResponse(httpResponse, request, body: responseBody);
    });
    ...
    _httpClient
        ...
        .then((request) async {
      _khodam.onHttpClientRequest(request);
      var httpResponse = await request.close();
      var responseBody = await utf8.decoder.bind(httpResponse).join();
      _khodam.onHttpClientResponse(httpResponse, request, body: responseBody);
    });
